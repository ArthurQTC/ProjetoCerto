        ...
        {isGlobalCostModalOpen && (
          <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs z-50 flex items-center justify-center p-4">
            <motion.div
              ...
              className="bg-white rounded-2xl w-full max-w-md shadow-xl border border-slate-100 p-6 space-y-5 overflow-hidden text-left"
            >
              {!isGlobalConfirmOpen ? (
                // STEP 1: FORM
                <div className="space-y-4">
                  <div className="flex items-center gap-2 pb-2 border-b border-slate-100">
                    <div className="p-2 bg-brand-primary/5 rounded-lg text-brand-primary animate-pulse">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-bold text-brand-text-secondary uppercase">
                        Módulos Consolidados e a Fechar
                      </p>
                    </div>
                  </div>

                  <p className="text-xs text-brand-text-secondary leading-relaxed font-semibold">
                    Esta alteração definirá a porcentagem padrão para todas as obras e recalculará os custos operacionais correspondentes.
                  </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-2 pb-2 border-b border-slate-100">
                    ...
                    <div>
                      <h3 className="text-sm font-black uppercase text-red-650 tracking-wider">
                        Confirmar Alteração Global
                      </h3>
                      <p className="text-[10px] font-bold text-brand-text-secondary uppercase">
                        Ação em lote solicitada no Dashboard
                      </p>
                    </div>
                  </div>

                  <div className="text-xs text-brand-text-primary font-bold leading-relaxed bg-red-50 p-4 rounded-xl border border-red-100">
                    Esta ação irá alterar o Custo ADM de todas as obras cadastradas.
                    <br />
