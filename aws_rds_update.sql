...
-- 7. Adicionando campos faltantes na tabela obras caso não tenham sido criados
...
CREATE TABLE IF NOT EXISTS "levantamento_materiais" (
  "id" VARCHAR(255) PRIMARY KEY,
  "levantamento_id" VARCHAR(255) NOT NULL,
  "material" TEXT NOT NULL,
  "qtd_m2" DOUBLE PRECISION NOT NULL DEFAULT 0.0,
  "createdAt" TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT "levantamento_materiais_levantamento_id_fkey" FOREIGN KEY ("levantamento_id") REFERENCES "levantamentos"("id") ON DELETE CASCADE
);
